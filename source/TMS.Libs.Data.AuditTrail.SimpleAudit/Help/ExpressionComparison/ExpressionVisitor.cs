...
internal abstract class ExpressionVisitor
{
    ...
    protected virtual void VisitUnary(UnaryExpression unary) => Visit(unary.Operand);
    ...
    protected virtual void VisitMemberAccess(MemberExpression member) => Visit(member.Expression);
    ...
    protected virtual void VisitExpressionList<TExp>(ReadOnlyCollection<TExp> list) where TExp : Expression => VisitList(list, Visit);

    protected virtual void VisitMemberAssignment(MemberAssignment assignment) => Visit(assignment.Expression);
    ...
    protected virtual void VisitBindingList<TBinding>(ReadOnlyCollection<TBinding> list) 
    ...
    protected virtual void VisitLambda(LambdaExpression lambda) => Visit(lambda.Body);

    protected virtual void VisitNew(NewExpression nex) => VisitExpressionList(nex.Arguments);
